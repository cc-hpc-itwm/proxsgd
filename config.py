...
result_dir= 'results_random_search/'                                      # Result directory to save all the experiments
...
study_name='hyperparameter_randomsearch'                                  # Database filename to save history of earlier trials.
