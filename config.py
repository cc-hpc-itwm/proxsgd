...
result_dir= 'results_newSetup/'                                           # Result directory to save all the experiments
...
threshold= [2.0,2.5]                                                      # Pruning Threshold. Prune weights when weights are less than corresponding layer's Standarad deviation * threshold 
...
study_name='hyperparameter_search'                                        # Database filename to save history of earlier trials.
