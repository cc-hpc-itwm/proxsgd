...
def start_dense201(epsilon, epsilon_decay, rho, rho_decay, mu):
...
>>>>>>> 1e2d3b3ccf48088f70798cf4eb315a9b9610f1f8
...
#Start a run
start_dense201(epsilon=0.2122, epsilon_decay=0.5981, rho=0.9, rho_decay=0.5, mu=1e-5)